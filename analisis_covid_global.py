...
full=pd.pivot_table(data=vacunas,values='people_fully_vaccinated_per_hundred',
                        index='Period',columns='location',aggfunc=np.nanmax)
...
plt.plot(muertes_mensuales.index,muertes_mensuales['Colombia']/pob2021['PopTotal']['Colombia'],'gold')
plt.plot(muertes_mensuales.index,muertes_mensuales['Mexico']/pob2021['PopTotal']['Mexico'],'b')
plt.plot(muertes_mensuales.index,muertes_mensuales['Argentina']/pob2021['PopTotal']['Argentina'],'r')
plt.plot(muertes_mensuales.index,muertes_mensuales['Peru']/pob2021['PopTotal']['Peru'],'m')
plt.plot(muertes_mensuales.index,muertes_mensuales['Chile']/pob2021['PopTotal']['Chile'],'c')
plt.plot(muertes_mensuales.index,muertes_mensuales['Brazil']/pob2021['PopTotal']['Brazil'],'lime')
plt.plot(muertes_mensuales.index,muertes_mensuales['Panama']/pob2021['PopTotal']['Panama'],'brown')
plt.plot(muertes_mensuales.index,muertes_mensuales['Uruguay']/pob2021['PopTotal']['Uruguay'],'k')
plt.plot(muertes_mensuales.index,muertes_mensuales['Paraguay']/pob2021['PopTotal']['Paraguay'],'grey')
plt.title('Monthly COVID-19 Deaths per Capita Latin America',size=15)
plt.title('cadecastro.com',size=10,loc='right')
plt.ylabel('Monthly Deaths per Capita')
...
plt.plot(muertes_mensuales.index,muertes_mensuales['United Kingdom']/pob2021['PopTotal']['United Kingdom'],'gold')
plt.plot(muertes_mensuales.index,muertes_mensuales['Germany']/pob2021['PopTotal']['Germany'],'b')
plt.plot(muertes_mensuales.index,muertes_mensuales['France']/pob2021['PopTotal']['France'],'r')
plt.plot(muertes_mensuales.index,muertes_mensuales['Spain']/pob2021['PopTotal']['Spain'],'g')
plt.plot(muertes_mensuales.index,muertes_mensuales['Greece']/pob2021['PopTotal']['Greece'],'m')
plt.plot(muertes_mensuales.index,muertes_mensuales['Denmark']/pob2021['PopTotal']['Denmark'],'c')
plt.plot(muertes_mensuales.index,muertes_mensuales['Netherlands']/pob2021['PopTotal']['Netherlands'],'lime')
plt.plot(muertes_mensuales.index,muertes_mensuales['Belgium']/pob2021['PopTotal']['Belgium'],'brown')
plt.plot(muertes_mensuales.index,muertes_mensuales['Italy']/pob2021['PopTotal']['Italy'],'k')
plt.plot(muertes_mensuales.index,muertes_mensuales['Poland']/pob2021['PopTotal']['Poland'],'grey')
plt.title('Monthly COVID-19 Deaths per Capita Europe',size=15)
plt.title('cadecastro.com',size=10,loc='right')
plt.ylabel('Monthly Deaths per Capita')
plt.xlabel('Data source: CSSEGISandData/COVID-19 & https://population.un.org/',size=8)
plt.grid(True,'both','both')
...
plt.plot(muertes_mensuales.index,muertes_mensuales['US']/pob2021['PopTotal']['United States of America'],'b')
plt.plot(muertes_mensuales.index,muertes_mensuales['United Kingdom']/pob2021['PopTotal']['United Kingdom'],'r')
plt.plot(muertes_mensuales.index,muertes_mensuales['Ireland']/pob2021['PopTotal']['Ireland'],'g')
plt.plot(muertes_mensuales.index,muertes_mensuales['Australia']/pob2021['PopTotal']['Australia'],'c')
plt.plot(muertes_mensuales.index,muertes_mensuales['New Zealand']/pob2021['PopTotal']['New Zealand'],'m')
plt.plot(muertes_mensuales.index,muertes_mensuales['Canada']/pob2021['PopTotal']['Canada'],'y')
plt.title('Monthly COVID-19 Deaths per Capita Anglo',size=15)
plt.title('cadecastro.com',size=10,loc='right')
plt.ylabel('Monthly Deaths per Capita')
plt.xlabel('Data source: CSSEGISandData/COVID-19 & https://population.un.org/',size=8)
plt.grid(True,'both','both')
...
plt.plot(muertes_mensuales.index,muertes_mensuales['Japan']/pob2021['PopTotal']['Japan'],'b')
plt.plot(muertes_mensuales.index,muertes_mensuales['Vietnam']/pob2021['PopTotal']['Viet Nam'],'r')
plt.plot(muertes_mensuales.index,muertes_mensuales['India']/pob2021['PopTotal']['India'],'g')
plt.plot(muertes_mensuales.index,muertes_mensuales['Philippines']/pob2021['PopTotal']['Philippines'],'c')
plt.plot(muertes_mensuales.index,muertes_mensuales['Thailand']/pob2021['PopTotal']['Thailand'],'m')
plt.plot(muertes_mensuales.index,muertes_mensuales['Korea, South']/pob2021['PopTotal']['Republic of Korea'],'y')
plt.title('Monthly COVID-19 Deaths per Capita East Asia',size=15)
plt.title('cadecastro.com',size=10,loc='right')
plt.ylabel('Monthly Deaths per Capita')
plt.xlabel('Data source: CSSEGISandData/COVID-19 & https://population.un.org/',size=8)
plt.grid(True,'both','both')
...
#Muertes año 2022 (ola de Ómicron al inicio de año):
m2022=muertes_diarias.groupby(by='Year').sum()
m2022=m2022.transpose()
m2022=m2022[[2022]].rename(columns={2022:'Deaths 2022'})

#Muertes per capita 2022:
#Muertes per capita 2022 Latinoamérica:
mpc2022_latam=pd.DataFrame(data=[m2022['Deaths 2022']['Colombia']/pob2021['PopTotal']['Colombia'],m2022['Deaths 2022']['Mexico']/pob2021['PopTotal']['Mexico'],
                               m2022['Deaths 2022']['Argentina']/pob2021['PopTotal']['Argentina'],m2022['Deaths 2022']['Peru']/pob2021['PopTotal']['Peru'],
                               m2022['Deaths 2022']['Ecuador']/pob2021['PopTotal']['Ecuador'],m2022['Deaths 2022']['Panama']/pob2021['PopTotal']['Panama'],
                               m2022['Deaths 2022']['Brazil']/pob2021['PopTotal']['Brazil'],m2022['Deaths 2022']['Chile']/pob2021['PopTotal']['Chile'],
                               m2022['Deaths 2022']['Uruguay']/pob2021['PopTotal']['Uruguay'],m2022['Deaths 2022']['Paraguay']/pob2021['PopTotal']['Paraguay']],
                         index=['Colombia','Mexico','Argentina','Peru','Ecuador','Panama','Brazil','Chile','Uruguay','Paraguay'])
mpc2022_latam=mpc2022_latam.rename(columns={0:'Deaths per capita'})
mpc2022_latam=mpc2022_latam.sort_values(by='Deaths per capita',ascending=False)

#Muertes per capita 2022 Europa:
mpc2022_eur=pd.DataFrame(data=[m2022['Deaths 2022']['Portugal']/pob2021['PopTotal']['Portugal'],m2022['Deaths 2022']['Germany']/pob2021['PopTotal']['Germany'],
                               m2022['Deaths 2022']['France']/pob2021['PopTotal']['France'],m2022['Deaths 2022']['Italy']/pob2021['PopTotal']['Italy'],
                               m2022['Deaths 2022']['Austria']/pob2021['PopTotal']['Austria'],m2022['Deaths 2022']['Poland']/pob2021['PopTotal']['Poland'],
                               m2022['Deaths 2022']['Sweden']/pob2021['PopTotal']['Sweden'],m2022['Deaths 2022']['Spain']/pob2021['PopTotal']['Spain'],
                               m2022['Deaths 2022']['Greece']/pob2021['PopTotal']['Greece'],m2022['Deaths 2022']['Denmark']/pob2021['PopTotal']['Denmark'],
                               m2022['Deaths 2022']['Netherlands']/pob2021['PopTotal']['Netherlands'],m2022['Deaths 2022']['Belgium']/pob2021['PopTotal']['Belgium'],
                               m2022['Deaths 2022']['Russia']/pob2021['PopTotal']['Russian Federation'],m2022['Deaths 2022']['Finland']/pob2021['PopTotal']['Finland']],
                         index=['Portugal','Germany','France','Italy','Austria','Poland','Sweden','Spain','Greece','Denmark','Netherlands','Belgium','Russia','Finland'])
mpc2022_eur=mpc2022_eur.rename(columns={0:'Deaths per capita'})
mpc2022_eur=mpc2022_eur.sort_values(by='Deaths per capita',ascending=False)

#Muertes per capita 2022 países anglos:
mpc2022_ang=pd.DataFrame(data=[m2022['Deaths 2022']['United Kingdom']/pob2021['PopTotal']['United Kingdom'],m2022['Deaths 2022']['US']/pob2021['PopTotal']['United States of America'],
                               m2022['Deaths 2022']['Ireland']/pob2021['PopTotal']['Ireland'],m2022['Deaths 2022']['Australia']/pob2021['PopTotal']['Australia'],
                               m2022['Deaths 2022']['New Zealand']/pob2021['PopTotal']['New Zealand'],m2022['Deaths 2022']['Canada']/pob2021['PopTotal']['Canada']],
                         index=['United Kingdom','United States','Ireland','Australia','New Zealand','Canada'])
mpc2022_ang=mpc2022_ang.rename(columns={0:'Deaths per capita'})
mpc2022_ang=mpc2022_ang.sort_values(by='Deaths per capita',ascending=False)

#Muertes per capita 2022 países asiáticos:
mpc2022_asia=pd.DataFrame(data=[m2022['Deaths 2022']['Japan']/pob2021['PopTotal']['Japan'],m2022['Deaths 2022']['Vietnam']/pob2021['PopTotal']['Viet Nam'],
                               m2022['Deaths 2022']['India']/pob2021['PopTotal']['India'],m2022['Deaths 2022']['Philippines']/pob2021['PopTotal']['Philippines'],
                               m2022['Deaths 2022']['Thailand']/pob2021['PopTotal']['Thailand'],m2022['Deaths 2022']['Korea, South']/pob2021['PopTotal']['Republic of Korea'],
                               m2022['Deaths 2022']['Mongolia']/pob2021['PopTotal']['Mongolia'],m2022['Deaths 2022']['Indonesia']/pob2021['PopTotal']['Indonesia']],
                         index=['Japan','Vietnam','India','Philippines','Thailand','South Korea','Mongolia','Indonesia'])
mpc2022_asia=mpc2022_asia.rename(columns={0:'Deaths per capita'})
mpc2022_asia=mpc2022_asia.sort_values(by='Deaths per capita',ascending=False)

#Muertes per capita 2022 medio oriente:
mpc2022_med=pd.DataFrame(data=[m2022['Deaths 2022']['Israel']/pob2021['PopTotal']['Israel'],m2022['Deaths 2022']['Turkey']/pob2021['PopTotal']['Turkey'],
                               m2022['Deaths 2022']['Jordan']/pob2021['PopTotal']['Jordan'],m2022['Deaths 2022']['Saudi Arabia']/pob2021['PopTotal']['Saudi Arabia'],
                               m2022['Deaths 2022']['Iran']/pob2021['PopTotal']['Iran (Islamic Republic of)'],m2022['Deaths 2022']['Iraq']/pob2021['PopTotal']['Iraq'],
                               m2022['Deaths 2022']['Lebanon']/pob2021['PopTotal']['Lebanon'],m2022['Deaths 2022']['Egypt']/pob2021['PopTotal']['Egypt'],
                               m2022['Deaths 2022']['Libya']/pob2021['PopTotal']['Libya'],m2022['Deaths 2022']['Pakistan']/pob2021['PopTotal']['Pakistan']],
                         index=['Israel','Turkey','Jordan','Saudi Arabia','Iran','Iraq','Lebanon','Egypt','Libya','Pakistan'])
mpc2022_med=mpc2022_med.rename(columns={0:'Deaths per capita'})
mpc2022_med=mpc2022_med.sort_values(by='Deaths per capita',ascending=False)

#Muertes per capita 2022 África:
mpc2022_africa=pd.DataFrame(data=[m2022['Deaths 2022']['Nigeria']/pob2021['PopTotal']['Nigeria'],m2022['Deaths 2022']['South Africa']/pob2021['PopTotal']['South Africa'],
                               m2022['Deaths 2022']['Kenya']/pob2021['PopTotal']['Kenya'],m2022['Deaths 2022']['Malawi']/pob2021['PopTotal']['Malawi'],
                               m2022['Deaths 2022']['Mozambique']/pob2021['PopTotal']['Mozambique'],m2022['Deaths 2022']['Ethiopia']/pob2021['PopTotal']['Ethiopia'],
                               m2022['Deaths 2022']['Namibia']/pob2021['PopTotal']['Namibia'],m2022['Deaths 2022']['Rwanda']/pob2021['PopTotal']['Rwanda']],
                         index=['Nigeria','South Africa','Kenya','Malawi','Mozambique','Ethiopia','Namibia','Rwanda'])
mpc2022_africa=mpc2022_africa.rename(columns={0:'Deaths per capita'})
mpc2022_africa=mpc2022_africa.sort_values(by='Deaths per capita',ascending=False)

#Muertes per capita 2022 mundial:
mpc2022_mund=mpc2022_latam.append([mpc2022_eur,mpc2022_ang,mpc2022_asia,
                                           mpc2022_med,mpc2022_africa]).sort_values(by='Deaths per capita',ascending=False)


#DataFrame con vacunas totales en 2021:
comp2022=pd.merge(left=mpc2022_mund,right=vac_full,left_index=True,right_index=True)


x=comp2022['people_fully_vaccinated_per_hundred']
y=comp2022['Deaths per capita']
correlation_matrix = np.corrcoef(x, y)
correlation_xy = correlation_matrix[0,1]
R2 = correlation_xy**2
R2=str(np.format_float_positional(R2,precision=3))
...
plt.plot(x,y,'bo')
plt.plot(x,y1,'r')
plt.title('Deaths per capita in 2022 (meanwhile) vs. People Fully Vaccinated at end of 2021 - R²='+R2,size=14,loc='left')
plt.title('cadecastro.com',size=10,loc='right')
plt.ylabel('COVID-19 Deaths/Population in 2022',size=12)
plt.xlabel('People Fully Vaccinated at the end of 2021 (%)',size=12)
plt.grid(True,'both','both')
plt.ylim(0,None)
for index in range(len(x)):
  ax.text(x[index], y[index], comp2022.index[index], size=11)

#Muertes anuales:
m_anuales=muertes_diarias.groupby(by='Year').sum()
print(m_anuales)

pais=str(input('Country to graph: '))

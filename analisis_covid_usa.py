...
plt.plot(muertes_us.index,muertes_us['New York'].rolling(window=7).mean()/poblacion['New York'],'b')
plt.plot(muertes_us.index,muertes_us['Florida'].rolling(window=7).mean()/poblacion['Florida'],'r')
plt.plot(muertes_us.index,muertes_us['California'].rolling(window=7).mean()/poblacion['California'],'c')
plt.plot(muertes_us.index,muertes_us['Texas'].rolling(window=7).mean()/poblacion['Texas'],'m')
plt.plot(muertes_us.index,muertes_us[estado].rolling(window=7).mean()/poblacion[estado],'g')
plt.legend(['New York','Florida','California','Texas',estado])
plt.title('7-days rolling average of deaths per capita with COVID-19',loc='center')

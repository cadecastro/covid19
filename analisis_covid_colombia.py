...
plt.plot(fecha_muerte.index,fecha_muerte.rolling(window =7).mean(),'r')
...
plt.subplot(212)
plt.bar(fecha_sint.index,fecha_sint,color='blue')
plt.plot(fecha_sint.index,fecha_sint.rolling(window =7).mean(),'r')
plt.grid(True,'both','both')
plt.ylim(0,None)
plt.legend(['Media semanal','Datos'])
...
plt.ylabel('Muertes diarias')
plt.subplot(212)
plt.bar(fecha_sint_dep.index,fecha_sint_dep,color='blue')
plt.plot(fecha_sint_dep.index,fecha_sint_dep.rolling(window =7).mean(),'r')
plt.grid(True,'both','both')
plt.ylim(0,None)
plt.legend(['Media semanal','Datos'])

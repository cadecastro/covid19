...
plt.grid(True,'both','both')
plt.ylim(0,None)
plt.xlim(fecha_sint.index[0],fecha_sint.index[len(fecha_sint)-6])
plt.legend(['Media móvil 7 días','Datos'])
...
plt.plot(mpc.index[:len(mpc.index)-2],mpc['VALLE'][:len(mpc.index)-2].rolling(window=7).mean(),'g')
...
plt.grid(True,'both','both')
plt.ylim(0,None)
plt.xlim(fecha_sint.index[len(fecha_sint)-36],fecha_sint.index[len(fecha_sint)-6])
...
plt.grid(True,'both','both')
plt.ylim(0,None)
plt.xlim(fecha_sint_dep.index[0],fecha_sint_dep.index[len(fecha_sint_dep)-6])
plt.legend(['Media móvil 7 días','Datos'])
...
plt.grid(True,'both','both')
plt.ylim(0,None)
plt.xlim(fecha_sint_dep.index[len(fecha_sint_dep)-36],fecha_sint_dep.index[len(fecha_sint_dep)-6])
plt.ylabel('Casos diarios')
plt.xlabel('cadecastro.com')

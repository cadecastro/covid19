...
fecha_sint_dep=fecha_sint.sort_index()
...
plt.subplot(212)
plt.bar(fecha_sint.index[:len(fecha_sint)-15],fecha_sint[:len(fecha_sint)-15],color='blue')
plt.plot(fecha_sint.index[:len(fecha_sint)-15],fecha_sint[:len(fecha_sint)-15].rolling(window =7).mean(),'r')
plt.grid(True,'both','both')
plt.ylim(0,None)
plt.legend(['Media semanal','Datos'])
...
plt.ylabel('Muertes diarias')
plt.subplot(212)
plt.bar(fecha_sint_dep.index[:len(fecha_sint_dep)-15],fecha_sint_dep[:len(fecha_sint_dep)-15],color='blue')
plt.plot(fecha_sint_dep.index[:len(fecha_sint_dep)-15],fecha_sint_dep[:len(fecha_sint_dep)-15].rolling(window =7).mean(),'r')
plt.grid(True,'both','both')
plt.ylim(0,None)
plt.legend(['Media semanal','Datos'])
...
plt.subplot(212)
plt.plot(CFR_dep,'b')
plt.ylabel('Tasa letalidad por caso')
plt.xlabel('cadecastro.com')
plt.grid(True,'both','both')
plt.legend(['CFR'])
plt.xlim(1,90)

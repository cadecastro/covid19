...
plt.plot(fecha_muerte.index[:len(fecha_muerte)-2],fecha_muerte[:len(fecha_muerte)-2].rolling(window =7).mean(),'b')
...
plt.plot(fecha_muerte_dep[:len(fecha_muerte_dep)-2].rolling(window =7).mean(),'b')
